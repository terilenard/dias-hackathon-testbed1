...
SERVICE_NAME=key_manager_master.service
...
# Log file
touch $LOG_PATH/master_kmngr.log
...
cp ../../modules/dias-ltk-stk/config/master_kmngr.ini $CONFIG_PATH
